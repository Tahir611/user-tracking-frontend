...
function StudentViewCommonHeader() {
    ...
    return (
        <>
            <header className="flex items-center justify-between p-4 border-b relative">
                <div className="flex items-center space-x-4">
                    <Link
                        ...
                        style={{
                            fontFamily:
                                userPreferences.preferredFonts?.[0] ||
                                "inherit",
                            color:
                                userPreferences.preferredColors?.[0] ||
                                "inherit",
                            transitionDuration:
                                userPreferences.preferredAnimationSpeed ===
                                "slow"
                                    ? "500ms"
                                    : userPreferences.preferredAnimationSpeed ===
                                      "fast"
            ...
            <header className="flex items-center justify-between pl-14 py-2 border-b relative">
                <div className="flex items-center space-x-4">
                    {auth?.user && (
                        <div className="flex gap-8 leading-tight">
