...
//         if (submitted) return; // disable if already submitted

//         const correct = selectedOption === questions[qIndex].correct;
//         setSelectedAnswers((prev) => ({ ...prev, [qIndex]: selectedOption }));

//         // score update
//         setScore((prev) => {
//             // If user changes answer before submit (optional safeguard)
//             const alreadyCorrect = prev[qIndex] === questions[qIndex].correct;
//             if (correct && !alreadyCorrect) return prev + 1;
//             return prev;
//         });
//     };
                                ...
                                <div className="flex gap-2 mt-1 flex-wrap">
                                    {q.a.map((opt) => {
                                        ...
                                        return (
                                            <button
                                                key={opt}
                                                className={`px-2 py-1 border rounded transition-all duration-150 ${
                                                    isSelected
                                                        ? "bg-blue-500 text-white"
                                                        : "hover:bg-gray-100"
                                                }`}
                                    ...
                                    <div className="flex gap-2 mt-1 flex-wrap">
                                        {q.a.map((opt) => {
                                            ...
                                            return (
                                                <button
                                                    key={opt}
                                                    className={`px-2 py-1 border rounded ${btnColor}`}
                                                    disabled
                                                >
                                                    {opt}
                                                </button>
